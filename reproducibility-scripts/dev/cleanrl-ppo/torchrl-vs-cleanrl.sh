# Baseline at 100M
python -m cleanrl.ppo_atari --exp_name baseline
python -m cleanrl.ppo_atari_2models --exp_name baseline_2models

# Change the env
python -m cleanrl.ppo_atari --env_id ALE/Phoenix-v5 --frameskip 3 --repeat_action_probability 0.25 --no-noop_reset --no-episodic_life --no-fire_reset --exp_name change-env
...
# Change the optim
python -m cleanrl.ppo_atari --no-layer_init --no-anneal_lr --no-clip_vloss --adam_eps 1e-8 --vf_coef 1 --exp_name change-optim
...
python -m cleanrl.ppo_atari --env_id ALE/Phoenix-v5 --frameskip 3 --repeat_action_probability 0.25 --no-noop_reset --no-episodic_life --no-fire_reset --no-layer_init --no-anneal_lr --no-clip_vloss --adam_eps 1e-8 --vf_coef 1 --exp_name change-env-optim
