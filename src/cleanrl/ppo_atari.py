...
class Args:
    ...
    wandb_project_name: str = "po-dynamics-cleanrl"
...
if __name__ == "__main__":
    ...
    for iteration in pbar:
            ...
            if "final_info" in infos:
                for info in infos["final_info"]:
                    if info and "episode" in info:
                        desc["perf"] = f"global_step={global_step} | episodic_return={info['episode']['r']}"
                        writer.add_scalar("batch/perf/avg_return_raw", info["episode"]["r"], global_step)
                        writer.add_scalar("batch/perf/max_timestep", info["episode"]["l"], global_step)
        ...
        b_hiddens = hiddens.reshape((-1, 512))
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                _, newlogprob, entropy, newvalue, __ = agent.get_action_and_value(
        ...
        ranks = metrics.compute_effective_ranks(
            [{"features_policy": b_hiddens, "features_value": b_hiddens}],
            ["batch"],
        ...
        writer.add_scalar(
            "batch/last_epoch/last_minibatch/loss/learning_rate", optimizer.param_groups[0]["lr"], global_step
        )
        ...
        writer.add_scalar("batch/last_epoch/last_minibatch/loss/kl_naive", old_approx_kl.item(), global_step)
        writer.add_scalar("batch/last_epoch/last_minibatch/loss/kl", approx_kl.item(), global_step)
