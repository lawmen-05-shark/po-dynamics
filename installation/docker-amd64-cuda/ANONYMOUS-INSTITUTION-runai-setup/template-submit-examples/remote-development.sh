...
runai submit \
  --interactive \
  --name po-dynamics-dev \
  --image registry.rcp.anonymous-institution.xyz/anonymous/anonymous/po-dynamics:dev-latest-anonymous \
  --pvc runai-anonymous-anonymous-scratch:/anonymous-rcp-scratch \
  -e PROJECT_ROOT_AT=/anonymous-rcp-scratch/home/anonymous/po-dynamics/dev \
  -e SSH_SERVER=1 \
